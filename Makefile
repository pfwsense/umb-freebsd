...
dist:
	...
	$(TAR) czf $(PACKAGE)-$(VERSION).tar.gz \
		...
		$(PACKAGE)-$(VERSION)/plugin/umb/src/pfwsense/scripts/PFWsense/umb/umbctl-gateway \
		$(PACKAGE)-$(VERSION)/plugin/umb/src/pfwsense/service/conf/actions.d/actions_umb.conf \
